...
| **Groups** | `security/groups/*.json` | 29 symbol groups (22 safe + 7 dangerous), generated locally by `mma-mcp setup` from the user's own Wolfram kernel (not distributed with the repository) |
